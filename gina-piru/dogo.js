...
class Dogo{
    constructor(){
        ...
        this.imagen.src = "player/dragon.png";
        /* tamano personaje */
        this.ancho = 60;
        this.alto = 50;
   ...
   jump() { 
    ...
    // crouch() {this.Y = Math.max(0, this.Y+15) ; }
};
...
function check_match(player, enemy){
    ...
    if((py < EY) || (px2 < Ex1) || (px1 > Ex2)){
        ...
        alert("FDSAFDSAFDSAFDSAFDSAFDSA")
        gameover=true
    }
}
